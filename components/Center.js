...
function Center() {
    ...
    useEffect(() => {
        setColor(shuffle(colors).pop())         //it'll shuffle the colors array & pop the color
    }, [playlistId]);
    ...
    }, [spotifyApi, playlistId])                //to re-fetch information when required.
    ...
    return (
        <div className="flex-grow h-screen overflow-y-scroll scrollbar-hide">
            ...
            to-black ${color} h-80 text-white p-8 w-full`}
            >
                <img 
