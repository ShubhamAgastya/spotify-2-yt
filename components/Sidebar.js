...
function Sidebar() {
    ...
    //console.log(playlists);  to check my playlist array in console 
    console.log("You picked this playlist >>>",playlistId); // to store the playlist which we click on

  //  console.log(session);  to check user session for sign in/out on console
